// 컨퍼런스 포토월 배너 - 대형 (300cm × 200cm @ 150dpi)
// 실행: node scripts/generate-conference-photowall-large.mjs
...
const WIDTH_CM = 300, HEIGHT_CM = 200;
const W = Math.round((WIDTH_CM / CM_PER_INCH) * DPI);   // 17717
const H = Math.round((HEIGHT_CM / CM_PER_INCH) * DPI);  // 11811
const OUT = path.join(process.env.HOME, "Downloads/더나일-컨퍼런스-포토월-대형.png");
